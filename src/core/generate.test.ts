...
test("weekly validator rejects raw template output and accepts filled output", () => {
  assert.equal(isValidWeeklyOllamaOutput(weeklyTemplate, weeklyTemplate, "2026-03-20"), false);
  assert.equal(
...
test("monthly validator rejects raw template output and accepts filled output", () => {
  assert.equal(isValidMonthlyOllamaOutput(monthlyTemplate, monthlyTemplate, "2026-03"), false);
  assert.equal(
